...
class CommonObjectGenerator:
    ...
    def __init__(self):
        self.emu = Emulator(Utils.get_json_to_dict(os.getcwd() + '/src/config/emulator_config.json'))
        self.db = Query(Utils.get_json_to_dict(os.getcwd() + '/src/config/database_config.json')['DB_conn_str'])
