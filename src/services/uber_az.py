...
class Uber_az(ActionsInterface):
    def __init__(self, emulator_instance: Emulator):
        ...
        ) = emulator_instance.get_Exceptions()
        try:
            self.package_name = (
                subprocess.check_output(
                    f"adb -s {self.emu.device_name} shell pm list packages | grep dkapp",
                    shell=True,
                )
                .decode()
                .split(":")[-1]
    ...
    def start_uber_app(self):
        ...
        os.system(
            f"adb -s {self.emu.device_name} shell monkey -p {self.package_name} -c android.intent.category.LAUNCHER 1"
        )
    ...
    def kill_uber_app(self):
        ...
        os.system(
            f"adb -s {self.emu.device_name} shell am force-stop {self.package_name}"
        )
        time.sleep(15)
    ...
    def grant_permissions(self):
        os.system(
            f"adb -s {self.emu.device_name} shell pm grant {self.package_name} android.permission.CALL_PHONE"
        )

        time.sleep(2)

        os.system(
            f"adb -s {self.emu.device_name} shell pm grant {self.package_name} android.permission.POST_NOTIFICATIONS"
        )

        time.sleep(2)

        os.system(
            f"adb -s {self.emu.device_name} shell pm grant {self.package_name} android.permission.WRITE_EXTERNAL_STORAGE"
        )

        time.sleep(2)

        os.system(
            f"adb -s {self.emu.device_name} shell pm grant {self.package_name} android.permission.ACCESS_FINE_LOCATION"
        )
    ...
    def start_clone_app(self):
        ...
        os.system(
            f"adb -s {self.emu.device_name} shell monkey -p com.py.cloneapp.huawei -c android.intent.category.LAUNCHER 1"
        )
    ...
    def kill_clone_app(self):
        ...
        # os.system("adb shell am force-stop com.mlubv.uber.az")
        os.system(
            f"adb -s {self.emu.device_name} shell am force-stop com.py.cloneapp.huawei"
        )
        time.sleep(10)
    ...
    def click_gps_location_circle(self):
        ...
        try:
            self.driver.find_element_by_id(
                "com.mlubv.uber.az:id/icon_circle_button_image"
            ).click()
            self.wait(
                self.EC.presence_of_element_located(
                    (self.By.ID, "com.mlubv.uber.az:id/center")
                )
            )
    ...
    def submit_clone(self):
        self.driver.find_element_by_xpath(
            '//android.widget.TextView[@text = "Clone"]'
        ).click()
    ...
    def click_clone_button(self):
        ...
        time.sleep(8)
        self.driver.find_element_by_xpath(
            '//android.widget.ImageView[@resource-id="com.py.cloneapp.huawei:id/iv_btn_create"]'
        ).click()
        time.sleep(5)
    ...
    def click_uber_app(self):
        self.driver.find_element_by_xpath(
            '//android.widget.TextView[@text="Uber AZ"]'
        ).click()
    ...
    def click_device_privacy(self):
        self.driver.find_element_by_xpath(
            '//android.widget.TextView[@text="Device privacy"]'
        ).click()
    ...
    def edit_custom_android_id(self):
        self.driver.find_element_by_id(
            "com.py.cloneapp.huawei:id/iv_custom_androidid"
        ).click()
    ...
    def send_custom_anroid_id(self):
        ...
        self.driver.find_element_by_id("com.py.cloneapp.huawei:id/et").send_keys(
    ...
    def edit_custom_imei(self):
        self.driver.find_element_by_id(
            "com.py.cloneapp.huawei:id/iv_custom_imei_imsi"
        ).click()
    ...
    def send_custom_imei(self):
        ...
        time.sleep(3)
        self.driver.find_element_by_id("com.py.cloneapp.huawei:id/et_imei").send_keys(
    ...
    def click_where_to_banner(self, tries=0):
        ...
        try:
            self.driver.find_element_by_xpath(
                "//android.widget.TextView[@text='Where to?']"
            ).click()

            self.driver.find_element_by_id(
                "com.mlubv.uber.az:id/component_input_center"
            )
        ...
        self.wait(
            self.EC.presence_of_element_located(
                (self.By.ID, "com.mlubv.uber.az:id/component_input_center")
            )
        )
    ...
    def click_top_route(self):
        self.driver.find_element_by_xpath(
            "(//*[@resource-id = 'com.mlubv.uber.az:id/component_input_center'])[1]"
        ).click()
    ...
    def send_top_route(self, adress):
        ...
        self.wait(
            self.EC.presence_of_element_located(
                (
                    self.By.XPATH,
                    "//android.widget.LinearLayout[@resource-id = 'com.mlubv.uber.az:id/center']",
                )
            )
        )
    ...
    def clear_route(self):
        self.driver.find_element_by_xpath(
            '//android.widget.Button[@content-desc="Clear text box"]'
        ).click()

    def click_bottom_route(self):
        self.driver.find_element_by_xpath(
            "(//android.widget.EditText[@resource-id = 'com.mlubv.uber.az:id/component_list_item_input'])[2]"
        ).click()
    ...
    def confirm_ride(self):
        ...
        self.driver.find_element_by_xpath(
            '//android.widget.TextView[@text="Confirm Uber"]'
        ).click()
    ...
    def click_to_suggested_dest(self, is_bottom=None):
        ...
        if is_bottom:
            try:
                time.sleep(10)
                self.driver.find_element_by_xpath(
                    "//android.widget.TextView[@text='Enter phone number']"
                )
                return False
            except self.NoSuchElementException:
                try:
            ...
            self.wait(
                self.EC.presence_of_element_located(
                    (
                        self.By.XPATH,
                        "//android.widget.TextView[@resource-id = 'com.mlubv.uber.az:id/wide_tariff_cost']",
                    )
                )
            )
    ...
    def click_to_logout(self):
        ...
        self.wait(
            self.EC.presence_of_element_located(
                (
                    self.By.XPATH,
                    '(//android.widget.LinearLayout[@resource-id="com.mlubv.uber.az:id/buttons"]//android.widget.Button)[2]',
                )
            )
        )
    ...
    def click_enter_phone_number(self):
        self.driver.find_element_by_xpath(
            '//android.widget.LinearLayout[@resource-id="com.mlubv.uber.az:id/menu_personal_section"]//android.widget.Button[@resource-id="com.mlubv.uber.az:id/enter_phone"]'
        ).click()
    ...
    def delete_phone_number(self):  # FIXME
        ...
        self.wait(
            self.EC.presence_of_element_located((self.By.ID, "android:id/button1"))
        )
        ...
        self.wait(
            self.EC.presence_of_element_located(
                (self.By.ID, "com.mlubv.uber.az:id/button_next")
            )
        )
    ...
    def add_account(self):
        time.sleep(3)
        self.driver.find_element_by_xpath(
            "//android.widget.TextView[@class = 'android.widget.TextView'][@text = 'Add account']"
        ).click()
    ...
    def clear_phone_number(self):
        ...
        try:
            self.driver.find_element_by_id(
                "com.mlubv.uber.az:id/edit_phone_number"
            ).clear()
    ...
    def send_confirmation_code(self, confirmation_code):
        self.driver.find_element_by_id(
            "com.mlubv.uber.az:id/input_phone_code"
    ...
    def is_any_active_order(self):
        try:
            self.driver.find_element_by_xpath(
                '//android.widget.TextView[@text="Contact driver"]'
            )
            return True
        except self.NoSuchElementException:
            try:
                self.driver.find_element_by_xpath(
                    '//android.widget.TextView[@text="Call"]'
                )
                return True
            except self.NoSuchElementException:
                return False
    ...
    def get_all_driver_data(self):
        time.sleep(3)
        driver_name = self.driver.find_element_by_xpath(
            '//android.widget.FrameLayout[@resource-id="com.mlubv.uber.az:id/order_info_driver"]//android.widget.LinearLayout[@resource-id="com.mlubv.uber.az:id/center"]//android.widget.TextView[@resource-id="com.mlubv.uber.az:id/top"]'
        ).text
        time.sleep(3)
        car_description = self.driver.find_element_by_xpath(
            '//android.widget.TextView[@resource-id="com.mlubv.uber.az:id/car_description"]'
        ).text
        time.sleep(3)
    ...
    def cancel_active_search_ride(self):
        self.driver.find_element_by_xpath(
            '//android.widget.ImageView[@resource-id="com.mlubv.uber.az:id/icon_circle_button_image"]'
        ).click()
    ...
    def your_ride_will_be_cheaper_message_handler(self):
        self.driver.find_element_by_xpath(
            '//android.widget.LinearLayout[@resource-id="com.mlubv.uber.az:id/buttons"]//android.widget.Button[@text="Great"]'
        ).click()

    def check_for_device_block(self):
        try:
            self.driver.find_element_by_xpath(
                "//android.widget.Button[@text='Use another number']"
            )
...
if __name__ == "__main__":
    ...
    emu = Emulator(
        Utils.get_json_to_dict(
            os.path.dirname(os.getcwd()) + "/src/config/emulator_config.json"
        )
    )
